...
# Chuẩn Pythonic: Vừa gán vừa kiểm tra điều kiện (tiêu thụ hàng đợi hoặc đọc stream dữ liệu)
tasks = ["build", "test", "deploy"]
while tasks and (current_task := tasks.pop(0)):
    print("Walrus while processing task:", current_task)
