# Hàm type() - Kiểm tra kiểu dữ liệu của biến
name = 'Devin'
...
# Kiểm tra biến khớp với một trong nhiều kiểu bằng toán tử '|'
...
# Cạm bẫy bool là lớp con của int & Tối ưu hiệu năng ở tầng C:
