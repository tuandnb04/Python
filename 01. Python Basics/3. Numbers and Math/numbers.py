...
# 3. Phép toán nâng cao: // (chia lấy nguyên làm tròn xuống), % (chia lấy dư), ** (lũy thừa)
...
# 4. Ép kiểu dữ liệu (int, float)
print(int('45'), int(12.9))    # 45 12
print(float('7.8'), float(5))  # 7.8 5.0

# 5. Các hàm toán học có sẵn: round, abs, pow
