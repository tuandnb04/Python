...
# 2. Gán kết hợp với chuỗi (+ nối chuỗi, * lặp chuỗi)
text = 'Hello'
text += ' World'
text *= 2
print(text)    # 'Hello WorldHello World'

# 3. Python không hỗ trợ ++ / -- (phải dùng += 1 hoặc -= 1)
x = 5
print(++x)     # 5 (chỉ là toán tử dấu unary, không tăng giá trị)
x += 1
print(x)       # 6

# 4. Ứng dụng thực tế: Tính toán hóa đơn & chia tiền tip (Bill & Tip Splitter)
running_total = 0.0
