...
# Structured Concurrency (Đồng quy có cấu trúc): Quản lý vòng đời task an toàn.
# Tự động dọn dẹp (Auto-cleanup): Nếu 1 task bị lỗi, TaskGroup tự động hủy các task còn lại,
#    tránh rò rỉ tài nguyên và task "mồ côi" (orphaned tasks) mà gather() thường gặp.
# Tích hợp hoàn hảo với ExceptionGroup để bắt mọi lỗi phát sinh đồng thời.
