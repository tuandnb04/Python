...
# Generator Function với từ khóa 'yield'
...
# Generator Expression (Dùng ngoặc tròn, tương tự List Comprehension nhưng là Generator)
squares_gen = (x ** 2 for x in range(1, 4))
print("Generator expression as list:", list(squares_gen)) # [1, 4, 9]

# [TÍNH NĂNG PYTHON 3.12+ PEP 654]: itertools.batched
